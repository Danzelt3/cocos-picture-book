...
export class Capture {
    ...
    private static instance: Capture;

    public static get Instance() {
        if (!this.instance) {
            this.instance = new Capture();
        }
    ...
    captureNodeToRenderTexture(target: cc.Node, max = true) {
        ...
        camera.zoomRatio = max ? Math.max(cc.winSize.width / target.width, cc.winSize.height / target.height) : Math.min(cc.winSize.width / target.width, cc.winSize.height / target.height);
